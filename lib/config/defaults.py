...
_C.AGDATASET = CN()
_C.AGDATASET.NAME = "ag"
_C.AGDATASET.MODE = "relationship_train"                    # dataset mode, benchmark | 1600-400-400 | 2500-600-400, etc
_C.AGDATASET.PATH = "/media/engineering/Millenium Falcon/Thesis/ActionGenome/dataset/ag"
_C.AGDATASET.LOADER = 'object'                     # which kind of data loader to use, object | object+attribute | object+attribute+relationship
_C.AGDATASET.TRAIN_BATCH_SIZE = 4
_C.AGDATASET.TEST_BATCH_SIZE = 4
_C.AGDATASET.SIZE_DIVISIBILITY = 32
_C.AGDATASET.ASPECT_RATIO_GROUPING = True
_C.AGDATASET.IND_TO_OBJECT = ""
_C.AGDATASET.IND_TO_PREDICATE = ""

""""======================================="""

_C.AGINPUT = CN()
_C.AGINPUT.MIN_SIZE_TRAIN = (264,)   # Size of the smallest side of the image during training
_C.AGINPUT.MAX_SIZE_TRAIN = 480      # Maximum size of the side of the image during training
_C.AGINPUT.MIN_SIZE_TEST = 264       # Size of the smallest side of the image during testing
_C.AGINPUT.MAX_SIZE_TEST = 480      # Maximum size of the side of the image during testing
_C.AGINPUT.PIXEL_MEAN = [102.9801, 115.9465, 122.7717]  # Values to be used for image normalization !!! CHANGE LATER !!!
_C.AGINPUT.PIXEL_STD = [1., 1., 1.]  # Values to be used for image normalization
_C.AGINPUT.TO_BGR255 = True          # Convert image to BGR format (for Caffe2 models), in range 0-255
_C.AGINPUT.BRIGHTNESS = 0.0          # Image ColorJitter
_C.AGINPUT.CONTRAST = 0.0            # Image ColorJitter
_C.AGINPUT.SATURATION = 0.0          # Image ColorJitter
_C.AGINPUT.HUE = 0.0                 # Image ColorJitter
_C.AGINPUT.VERTICAL_FLIP_PROB_TRAIN = 0.0
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 37 # AGINPUT Object classes, Originally 81
...
_C.MODEL.ROI_RELATION_HEAD.NUM_CLASSES = 27 # AGINPUT Relationship classes, Originally 81
_C.MODEL.ROI_RELATION_HEAD.TRIPLETS_PER_IMG = 24
...
_C.MODEL.RETINANET.NUM_CLASSES = 37 # AGINPUT Object classes
