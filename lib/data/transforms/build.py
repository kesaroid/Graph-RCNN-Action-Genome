...
def build_transforms(cfg, is_train=True):
    if is_train:
        min_size = cfg.AGINPUT.MIN_SIZE_TRAIN
        max_size = cfg.AGINPUT.MAX_SIZE_TRAIN
        ...
        min_size = cfg.AGINPUT.MIN_SIZE_TEST
    ...
    to_bgr255 = cfg.AGINPUT.TO_BGR255
    normalize_transform = T.Normalize(
        mean=cfg.AGINPUT.PIXEL_MEAN, std=cfg.INPUT.PIXEL_STD, to_bgr255=to_bgr255
    )
